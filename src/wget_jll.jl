...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import wget_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("25883557-5102-5516-a11b-f84f27e871d7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "wget", artifacts_toml) for e in artifacts["wget"]]
...
if best_platform === nothing
    @debug("Unable to load wget; unsupported platform $(triplet(platform_key_abi()))")
else
